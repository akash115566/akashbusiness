...
//     <>
//     <Helmet>
//   <title>About Business Care | MSME Growth & Business Consulting</title>
//   <meta 
//     name="description" 
//     content="Business Care helps MSMEs grow with expert strategies, financial planning, and TV media exposure. Learn about our journey and services." 
//   />
//  <link rel="canonical" href="https://businesscare.org.in/about" />
//    {/* ✅ SCHEMA MARKUP */}
...
//       "description": "Business consulting and MSME growth platform in India"
//     }
//     `}
//   </script>
// </Helmet>
...
//         <img src="/about/g9.webp" alt="Business" loading="lazy"/>
//       </div>
...
//         <img src="/about/m1.webp"   alt="Business growth strategy consulting"  loading="lazy"/>
//       </div>
//     </section>
...
//           <img src="/about/aw2.webp" alt="Case Study 1"    loading="lazy"/>
//         </div>

//         <div className="case-item">
//           <img src="/about/aw3.webp" alt="Case Study 2" loading="lazy"/>
//         </div>

//         <div className="case-item">
//           <img src="/about/g8.webp" alt="Case Study 3" loading="lazy"/>
//         </div>
...
//         <img src="/about/aw14.webp" alt="Innovation" loading="lazy" />
//       </div>
...
import "../Style/about.css";
import { Helmet } from "react-helmet";
import { FaPlay, FaHandshake, FaLightbulb, FaCalculator, FaChartLine, FaMoneyCheckAlt } from "react-icons/fa";
...
const About = () => {
  ...
  const [stats, setStats] = useState(statsData.map(item => ({ ...item, count: 0, progress: 0 })));
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setStats(prev =>
        prev.map(stat => ({
          ...stat,
          count: stat.count < stat.number ? stat.count + Math.ceil(stat.number / 60) : stat.number,
          progress: stat.progress < stat.percent ? stat.progress + 0.01 : stat.percent,
        }))
      );
    }, 300);
  ...
  return (
    <>
      ...
      <section className="about-section">
        ...
        <div className="about-content">
          <div className="about-text">
            <p style={{ fontSize: "20px" }}>
              Business Care was started by great minds in the media industry who have benefited thousands of
              business owners with their knowledge and wisdom. Business Care is such a wonderful research and
              initiative of these two scholars who have made their career in the media, appearing on many big TV
              channels. Founders of Business Care Miss Pooja Sharma is a media industry professional and
              television celebrity. Become entrepreneurs, and Mr. Ankur Bansal, who are very young in age. In 12
              years, the company has registered the title to open 14 companies. Their personality and knowledge
              make them a different person in the country. At a young age, they have become a well-known name of
              the country today. These two young minds have advanced knowledge of establishing a product in the
              market. The vast knowledge of these two is so great that by establishing many companies, they have
      ...
      <section className="enhance-timeline-section">
        <div className="container">
          <div className="left-side">
            ...
            <h3>Choose Correct Platform</h3>
            <p>
              Business is <b>New or Old</b> — We believe according to the need of the product we design marketing
              strategy for business owners. Through <strong>Business Care</strong>, we redefine the definition of
              business marketing. Now a business owner will not be confused in marketing business plans. Our expert
              team provides top services including yearly strategy with low investment.
            </p>
            <ul className="services-list">
              <li>💼 Valuation Services</li>
              <li>📊 Development of Financial Models</li>
      ...
      <section className="sales-section">
        ...
        <div className="sales-right">
          <h2>Create more Sales and grow your business</h2>
          <p>We can help you with picking out the Best strategy for your company and its work.</p>
          <a href="#" className="view-more">View More →</a>
        </div>
      </section>
      ...
      <section className="operation-section">
        <div className="operation-left">
          <h2>The operational processes of a business are what drives the business itself</h2>
          <p>We're here to inform which tactics need funding and which are drains on resources.</p>
      ...
      <section className="innovation-section">
        <div className="innovation-left">
          <img src="/about/aw14.webp"   alt="Innovation Award and Business Achievement"
