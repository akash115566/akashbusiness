...
const FormPage = () => {
  ...
  <label>
    <input type="checkbox" name="businessSegment" value="Education" /> Education
  </label>
    <label>
    <input type="checkbox" name="businessSegment" value="Exporters" /> Exporters
  </label>
   <label>
    <input type="checkbox" name="businessSegment" value="Health" /> Health
  </label>
    <label>
    <input type="checkbox" name="businessSegment" value="Skin Care" /> Skin Care
  </label>
</div>
...
<section className="legal-section">
  ...
  <div className="disclaimer-text">
    ...
    <p>
     ...
     <p>
      Broadcasting the content of the Business Care Show on any other channel without prior legal authorization from Business Care is strictly prohibited. Such action would constitute a violation, as the content is protected by copyright and is the exclusive property of Business Care. Any content that is exclusively designed by the Business Care program or is protected under copyright
    </p>
    <p>
       Please note that Business Care works only as a consultancy and business growth platform for various industries including SME, Healthcare, Education, Real Estate, Agriculture, Pharma, Skin Care, Food & Beverage, and other business sectors.
    </p>

    <p>
      Business Care provides branding, promotional, networking, consultancy, visibility, and business growth support services only.
    </p>

    <p>

      Business Care do not make or guarantee any fixed claims regarding admissions, sales, profits, investments, business growth, revenue generation, partnerships, or commercial outcomes, as results may vary depending upon market conditions, business profile, product/service quality, operational capability, audience response, and client-side execution.
    </p>

    <p>

      All promotional and consultancy services are executed on a best-effort basis through our media, branding, and business networking ecosystem.
    </p>

    <p>
      Please note that all payments related to Business Care / Education Care services must be made only to the official company accounts authorized by Business Care.
    </p>

    <p>
      If any individual, representative, employee, agent, or third party personally collects money in cash or through any unofficial account without official authorization or company confirmation, Business Care shall not be held responsible or liable for the same under any circumstances.
    </p>

    <p>
      Clients are strictly advised to verify all payment details with the official Business Care management before processing any transaction.
    </p>

    <p>

      Only payments made to officially approved company accounts and supported by valid payment confirmation shall be considered valid transactions.
    </p>
  </div>
